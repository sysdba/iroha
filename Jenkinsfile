properties([parameters([
  booleanParam(defaultValue: true, description: 'Whether build `iroha`', name: 'iroha'),
  booleanParam(defaultValue: false, description: 'Whether build `bindings`', name: 'bindings'),
  ...
  booleanParam(defaultValue: false, description: 'Whether build docs', name: 'Doxygen'),
